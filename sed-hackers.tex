...
\begin{frame}{Hackers}
  ...
  \begin{itemize}
    \item \href{http://www.catb.org/esr/faqs/hacker-howto.html}
      {\structure{\ding{43}~\color{sail-green}{How To Become A Hacker}}}, de Eric Raymond
...
\item \href{http://www.alfredodehoces.com/fuckowski-on-line}
      {\structure{\ding{43}~\color{sail-green}{Fuckowski}},
...
\begin{itemize}
  ...
  \item \href{http://www.valvesoftware.com/company/Valve_Handbook_LowRes.pdf}
        {\structure{\ding{43}~\color{sail-green}{Manual del nuevo empleado de Valve}}}
...
\begin{frame}{Dos casos}
  ...
  \begin{block}{Escenario B} \centering
    ...
    script programado en \structure{Python} que use la API de Telegram
    ...
    detectamos con \structure{smartctl}.
   \end{block}
...
\begin{frame}{Videojuegos}
  ...
  \begin{block}{\centering \small Lectura obligada}
    ...
    [\href{https://web.archive.org/web/20131211193933/http://penny-arcade.com/report/article/why-your-games-are-made-by-childless-31-year-old-white-men-and-how-one-stud}{\ding{43}~\color{sail-green}{Internet Archive}}]
  \end{block}
\end{frame}
...
\begin{frame}{Conclusión}
    ...
    \begin{itemize} \itemsep0em
      ...
      \item \href{https://vimeo.com/65666763}
            {\structure{\ding{43}~\color{sail-green}{What if Money Did not Matter?}}}, de Alan Watts
      \item \href{https://www.youtube.com/watch?v=rAn4gZCd4HY}
            {\structure{\ding{43}~\color{sail-green}{Everybody's Free To Wear Sunscreen}}}, de Baz Luhrmann
    \end{itemize}
\end{frame}
